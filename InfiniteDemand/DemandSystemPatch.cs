...
public class CommercialDemandSystemPatch
{
    ...
    {
        // 僅在設定啟用時才修改需求值
        if (InfiniteDemandMod.Settings?.EnableCommercialDemand == true)
        {
...
public class IndustrialDemandSystemPatch
{
    ...
    {
        // 僅在設定啟用時才修改需求值
        if (InfiniteDemandMod.Settings?.EnableIndustrialDemand == true)
        {
            // 設定工業建築需求為最大值
...
public class ResidentialDemandSystemPatch
{
    ...
    {
        // 僅在設定啟用時才修改需求值
        if (InfiniteDemandMod.Settings?.EnableResidentialDemand == true)
        {
